...
![](images/quality_of_life/Quality%20of%20Life_Saaty%20Matrix.png)
...
::::: {layout-ncol="2"}
::: column
![Green Cover: Analysis](images/climate_adaptation/3.1%20Green%20cover_%20Analysis.jpg){fig-cap="Green Cover: Green Spaces"}
:::

::: column
![Green Cover: MCDA Grid](images/climate_adaptation/3.2%20Green%20cover_%20MCDA%20Grid.jpg){fig-cap="Green Cover: MCDA Grid"}
:::
:::::
...
::::: {layout-ncol="2"}
::: column
![Infiltration: Analysis](images/climate_adaptation/5.1%20Infiltration%20properties_%20Analysis.jpg){fig-cap="Infiltration: Seepage Properties"}
:::

::: column
![Infiltration: MCDA Grid](images/climate_adaptation/5.2%20Infiltration%20properties_%20MCDA%20Grid.jpg){fig-cap="Infiltration: MCDA Grid"}
:::
:::::
...
::::: {layout-ncol="2"}
::: column
![Sealing Class: Analysis](images/climate_adaptation/6.1%20Sealing_%20Analysis.jpg){fig-cap="Sealing Class: Analysis"}
:::

::: column
![Sealing Class: MCDA Grid](images/climate_adaptation/6.2%20Sealing_%20MCDA%20Grid.jpg){fig-cap="Sealing Class: MCDA Grid"}
:::
:::::

#### Saaty Matrix

![](images/climate_adaptation/Climate%20Adaptation_Saaty%20Matrix.png)
...
![Tiles nearest to the centre of Cluster 1](images/recommendations/Cluster%201.jpg)

:::::: {layout-ncol="3"}
::: column
![Channel remeandering *(What is river restoration?, n.d.)*.](images/recommendations/Cluster%201.1.jpg){fig-cap="Channel remeandering"}
:::

::: column
![Blue-green infrastructure incoporation *(Fletcher et al., 2024)*.](images/recommendations/Cluster%201.2.jpg){fig-cap="Blue-green infrastructure incoporation. _(Fletcher et al., 2024)_"}
:::

::: column
![Large canopy in urban stream buffer *(Harding et al., 2009)*.](images/recommendations/Cluster%201.3.jpg){fig-cap="Large canopy in urban stream buffer. _(Harding et al., 2009)_"}
:::
::::::
...
![Tiles nearest to the centre of Cluster 2](images/recommendations/Cluster%202.jpg)

:::::: {layout-ncol="3"}
::: column
![Water retention basins around streams *(Noviandi et al., 2017)*.](images/recommendations/Cluster%202.1.jpg){fig-cap="Water retention basins around streams _(Noviandi et al., 2017)_."}
:::

::: column
![Wetlands along streams with socio-ecological programs *(Qunli National Urban Wetland by Turenscape, 2014)*.](images/recommendations/Cluster%202.2.jpg){fig-cap="Wetlands along streams with socio-ecological programs _(Qunli National Urban Wetland by Turenscape, 2014)_."}
:::

::: column
![Sediment management through reforested area *(Strategies- Hydropower, n.d.)*.](images/recommendations/Cluster%202.3.jpg){fig-cap="Sediment management through reforested area _(Strategies- Hydropower, n.d.)_."}
:::
::::::
...
![Tiles nearest to the centre of Cluster 3](images/recommendations/Cluster%203.jpg)

:::::: {layout-ncol="3"}
::: column
![Facilities such as seating and play areas in the vicinity *(Cox, 2020)*.](images/recommendations/Cluster%203.1.jpg){fig-cap="Facilities such as seating and play areas in the vicinity _(Cox, 2020)_."}
:::

::: column
![Daylighting urban streams *(Chung, 2025)*.](images/recommendations/Cluster%203.2.jpg){fig-cap="Daylighting urban streams _(Chung, 2025)_."}
:::

::: column
![Increased vegetation in riparian zone *(Carrasco, 2024)*.](images/recommendations/Cluster%203.3.jpg){fig-cap="Increased vegetation in riparian zone _(Carrasco, 2024)_."}
:::
::::::
...
As a result of the MCDA, the following map highlights twelve streams that have the greatest potential to contribute to the city’s integrated climate resilience through immediate urban restoration measures. It also highlights that the good stream conditions are predominantly in the Northern part of Dresden, which is largely covered by natural ecosystems. Whereas the rest of the streams not faring well are in the built environment South of the Elbe River. 
