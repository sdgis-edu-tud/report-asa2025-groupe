...
intro_imgs <- list(
  'Grid Generation: 500×500m cells covering Dresden study area' = "images/introduction/STEP1.png",
  'Stream Network Integration: Overlay of hydrological features' = "images/introduction/STEP2.png",
  'Data Refinement: Removal of extraneous information' = "images/introduction/STEP3.png"
)

htmltools::div(
  # APA-style figure number and caption
  tags$p(
    tags$b("Figure 1."),
  ...
  # Image container
  htmltools::div(
    style = "display: flex; justify-content: space-between; align-items: flex-start; gap: 20px; max-width: 100%;",
    lapply(names(intro_imgs), function(name) {
      tags$figure(
        style = "flex: 1; margin: 0; text-align: center; overflow: hidden; padding-bottom: 50px;",
        tags$img(
          src = intro_imgs[[name]],
          style = paste0("width: 100%; height: 300px; display: block; border: none; object-fit: cover; object-position: center; transform: scale(", zoom_level, ");")
        ),
        tags$figcaption(
          name,
          style = "margin-top: 15px; font-size: 14px; position: relative; z-index: 1;"
        )
      )
    })
  )
...
fig_caption <- "Figure 2. Physical Health: Vicinity to Urban Green Space."

img_paths <- list(
  "images/quality_of_life/VicinityToUrbanGreenSpace.jpeg",
  "images/quality_of_life/VicinityToUrbanGreenSpace_Grid.jpeg"
)
...
htmltools::div(
  ...
  htmltools::div(
    ...
    lapply(img_paths, function(path) {
      tags$img(
        src = path,
...
fig_caption <- "Figure X. Mental Health: Vicinity to Stream."

img_paths <- list(
  "images/quality_of_life/VicinityToStream.jpeg",
  "images/quality_of_life/VicinityToStream_Grid.jpeg"
)

htmltools::div(
  tags$p(tags$b(fig_caption), style = "text-align: center; margin-bottom: 15px; font-size: 14px;"),
  htmltools::div(
    style = "display: flex; justify-content: center; gap: 0px;",
    lapply(img_paths, function(path) {
      tags$img(src = path, style = "width: 50%; height: auto; border: none;")
    })
  )
)
```
...
fig_caption <- "Figure X. General Health: Facilities."

img_paths <- list(
  "images/quality_of_life/Facilities.jpeg",
  "images/quality_of_life/Facilities_Grid.jpeg"
)
...
fig_caption <- "Figure X. Accessibility: Local Integration."

img_paths <- list(
  "images/quality_of_life/LocalIntegration.jpeg",
  "images/quality_of_life/LocalIntegration_Grid.jpeg"
)
...
fig_caption <- "Figure X. Accessibility: Appearance."

img_paths <- list(
  "images/quality_of_life/Covered.jpeg",
  "images/quality_of_life/Covered_Grid.jpeg"
)
...
fig_caption <- "Figure X. Recreational Suitability."

img_paths <- list(
  "images/quality_of_life/RecreationalSuitability.png",
  "images/quality_of_life/RecreationalSuitability_Gridded.png"
)
...
fig_caption <- "Figure X. Flood Risk: Soil Storage and MCDA Grid."

img_paths <- list(
  "images/climate_adaptation/1.1 Flood risk_ Analysis.jpg",
  "images/climate_adaptation/1.2 Flood risk_ MCDA Grid.jpg"
)
...
fig_caption <- "Figure X. Urban Heat Island Effect: Analysis and MCDA Grid."

img_paths <- list(
  "images/climate_adaptation/2.1 UHI_ Analysis.jpg",
  "images/climate_adaptation/2.2 UHI_ MCDA Grid.jpg"
)
...
fig_caption <- "Figure X. Green Cover: Green Spaces and MCDA Grid."

img_paths <- list(
  "images/climate_adaptation/3.1 Green cover_ Analysis.jpg",
  "images/climate_adaptation/3.2 Green cover_ MCDA Grid.jpg"
)
...
fig_caption <- "Figure X. Green Cover: Urban Trees and MCDA Grid."

img_paths <- list(
  "images/climate_adaptation/4.1 Urban trees_ Analysis.jpg",
  "images/climate_adaptation/4.2 Urban trees_ MCDA Grid.jpg"
)
...
fig_caption <- "Figure X. Infiltration: Seepage Properties and MCDA Grid."

img_paths <- list(
  "images/climate_adaptation/5.1 Infiltration properties_ Analysis.jpg",
  "images/climate_adaptation/5.2 Infiltration properties_ MCDA Grid.jpg"
)
...
fig_caption <- "Figure X. Infiltration: Sealing Class and MCDA Grid."

img_paths <- list(
  "images/climate_adaptation/6.1 Sealing_ Analysis.jpg",
  "images/climate_adaptation/6.2 Sealing_ MCDA Grid.jpg"
)
...
fig_caption <- "Figure X. PM10 concentration and MCDA grid."

img_paths <- list(
  "images/biodiversity/PM10.png",
  "images/biodiversity/PM10_Gridded.png"
)
...
fig_caption <- "Figure X. NO2 concentration and MCDA grid."

img_paths <- list(
  "images/biodiversity/NO2.png",
  "images/biodiversity/NO2_Gridded.png"
)
...
fig_caption <- "Figure X. NDVI index and MCDA grid."

img_paths <- list(
  "images/biodiversity/NDVI.png",
  "images/biodiversity/NDVI_Gridded.png"
)
...
fig_caption <- "Figure X. Landscape quality and MCDA grid."

img_paths <- list(
  "images/biodiversity/LandscapeQuality.png",
  "images/biodiversity/LandscapeQuality_Gridded.png"
)
...
fig_caption <- "Figure X. Blue-green infrastructure percentage and MCDA grid."

img_paths <- list(
  "images/biodiversity/BlueGreenPercentage.png",
  "images/biodiversity/BlueGreenPercentage_Gridded.png"
)
