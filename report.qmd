...
To help visualise and get a better understanding of the distribution of our values across our datasets, we've made the following plot which displays the distribution of the normalised values for all the layers used in the saaty matrices, and the resultig distribution per theme.
