...
![Dresden landscape](images/introduction/Dresden abstract.png) 
...
For Cluster 1, which comprises highly urbanised and predominantly residential areas, incorporating channel remeandering restores hydrological dynamics, reduces flow velocity, and enhances sediment retention, thereby contributing to flood mitigation and ecological recovery (_What Is River Restoration?_, n.d.). Blue-green infrastructure, including bioswales, rain gardens, and constructed wetlands, supports stormwater management, improves water quality, and integrates public realm functions (Ahern, 2011). Large canopy trees within 10 meters of streams offer critical microclimatic regulation, reduce urban heat island effects, and stabilise banks through root structures, while enhancing habitat and user comfort (Gill et al., 2007). Together, these measures align ecological performance with urban liveability.

![Tiles nearest to the centre of Cluster 1](images/recommendations/Cluster 1.jpg)

::::: {layout-ncol="3"}
::: {.column}
![Channel remeandering _(What is river restoration?, n.d.)_.](images/recommendations/Cluster 1.1.jpg){fig-cap="Channel remeandering"}
:::
::: {.column}
![Blue-green infrastructure incoporation _(Fletcher et al., 2024)_.](images/recommendations/Cluster 1.2.jpg){fig-cap="Blue-green infrastructure incoporation. _(Fletcher et al., 2024)_"}
:::
::: {.column}
![Large canopy in urban stream buffer _(Harding et al., 2009)_.](images/recommendations/Cluster 1.3.jpg){fig-cap="Large canopy in urban stream buffer. _(Harding et al., 2009)_"}
:::
:::::
...
::::: {layout-ncol="3"}
::: {.column}
![Water retention basins around streams _(Noviandi et al., 2017)_.](images/recommendations/Cluster 2.1.jpg){fig-cap="Water retention basins around streams _(Noviandi et al., 2017)_."}
:::
::: {.column}
![Wetlands along streams with socio-ecological programs _(Qunli National Urban Wetland by Turenscape, 2014)_.](images/recommendations/Cluster 2.2.jpg){fig-cap="Wetlands along streams with socio-ecological programs _(Qunli National Urban Wetland by Turenscape, 2014)_."}
:::
::: {.column}
![Sediment management through reforested area _(Strategies- Hydropower, n.d.)_.](images/recommendations/Cluster 2.3.jpg){fig-cap="Sediment management through reforested area _(Strategies- Hydropower, n.d.)_."}
:::
:::::
...
::::: {layout-ncol="3"}
::: {.column}
![Facilities such as seating and play areas in the vicinity _(Cox, 2020)_.](images/recommendations/Cluster 3.1.jpg){fig-cap="Facilities such as seating and play areas in the vicinity _(Cox, 2020)_."}
:::
::: {.column}
![Daylighting urban streams _(Chung, 2025)_.](images/recommendations/Cluster 3.2.jpg){fig-cap="Daylighting urban streams _(Chung, 2025)_."}
:::
::: {.column}
![Increased vegetation in riparian zone _(Carrasco, 2024)_.](images/recommendations/Cluster 3.3.jpg){fig-cap="Increased vegetation in riparian zone _(Carrasco, 2024)_."}
:::
:::::
