...
As a result of the MCDA, the following map highlights twelve grid cells consisting of stretches of urban streams that have the greatest potential to contribute to the city’s integrated climate resilience through immediate urban restoration measures. It also highlights that the good stream conditions are predominantly in the Northern part of Dresden, which is largely covered by natural ecosystems. Whereas the rest of the streams not faring well are in the built environment South of the Elbe River.  
